...
function PizzaCard({id, imageUrl, title, types, sizes, price}) {
    return (
        <div className={styles.pizza}>
            <img src={pizzaImg} alt="" className={styles.img} />
            <h3 className={styles.title}>Чизбургер-пицца</h3>
            <div className={styles.options}>
                <div className={styles.thickness}>
                    <Option className={styles.option} text={'тонкое'}/>
                    <Option className={styles.option} disabled text={'традиционное'}/>
                </div>
                <div className={styles.width}>
                    <Option className={styles.option} text={'26 см.'}/>
                    <Option className={styles.option} disabled text={'30 см.'}/>
                    <Option className={styles.option} disabled text={'40 см.'}/>
                </div>
            </div>
            <div className={styles.bottom}>
                <div className={styles.price}>от <span>{price}</span> ₽</div>
